...
export const ANNOUNCEMENTS_DATA = [
    {
        ...
        time: '12:30',
        content:
            'بازی های جدید برای استفاده شما دانش آموزان عزیز در دسترس می باشد جهت استفاده به بخش ارتقا امتیاز مراجعه کنید',
    },
    {
        id: 2,
        title: 'ماموریت شما به پایان نرسید',
        date: '1404/06/10',
        time: '12:30',
        content:
            'بازی های جدید برای استفاده شما دانش آموزان عزیز در دسترس می باشد جهت استفاده به بخش ارتقا امتیاز مراجعه کنید',
