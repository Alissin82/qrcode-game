...
const ActionsPage = () => {
    ...
    return (
        <div className={`min-h-screen ${className} font-sans text-white`} dir="rtl">
            {scanning && <QrCodeScanner onScan={handleScan} onError={() => {}} isOpen={scanning} />}
                    ...
                    >
                        <div className="grid grid-cols-2 gap-4">
                            <div className="border-l border-white/20 text-center">
                                <h3 className="mb-2 text-sm font-bold">عملیات تکمیل شده</h3>
                            ...
                            <div className="pr-4 text-center">
                                <h3 className="mb-2 text-sm font-bold">مکان های تکمیل شده</h3>
                                <div className="text-2xl font-bold text-white">
                            ...
                            >
                                    ...
                                    {action.action_team_for ? (
                                        <div className="flex items-center gap-2">
                                            ...
                                            {action.action_team_for?.status == 'Pending' ? (
                                                ...
                                                <FaClock size={16} className={'text-red-500'} />
                                            )}
                                        </div>
                                    ) : action.region.locked ? (
                                        <div className="flex items-center gap-2">
                                            <span className="text-sm">رزرو شده</span>
                                            {<FaLock size={16} className={'text-yellow-500'} />}
                                        </div>
                                    ) : null}
                                </div>
                                ...
                                <div className="mb-4 grid grid-cols-2 gap-3">
                                    ...
                                    {action.action_team_for ? (
                                        ...
                                        <div className="rounded-lg bg-blue-800/50 p-3">
                                            <div className="mb-1 text-sm">تعداد وظایف</div>
                                            <span className="text-sm">{action.tasks_count}</span>
                                        </div>
                                    )}
                                </div>
