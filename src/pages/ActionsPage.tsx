...
const ActionsPage = () => {
    ...
    async function handleScan(id: any) {
        ...
        if (response.status == 200)
            navigate(`/mission/${response.data.data.id}`);
    }
                                        ...
                                        <>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <progress
                                                    ...
                                                    value={action.action_team_for ? (action.action_team_for.completed_task_count / action.tasks_count) * 100 : 0}
                                                    max={100}
                                                ></progress>
                                                <span className="text-sm">
                                            {action.action_team_for ? (action.action_team_for.completed_task_count / action.tasks_count) * 100 : 0}
                                                    %
                                        </span>
                                            </div>
                                        </>
