...
import { FaMapMarkerAlt, FaMedal, FaPencilAlt, FaPlay, FaStar } from 'react-icons/fa';
...
const MissionsPage = () => {
    ...
    return (
        <div className={`min-h-screen ${className} font-sans text-white`} dir="rtl">
            {scanning && (
                <div className={'absolute z-50 flex h-[100%] w-[100%] items-center justify-center'}>
                    <div
                        className={
                            'flex h-[90%] w-[90%] flex-col items-center justify-center gap-[24px] rounded-md bg-white'
                        }
                    >
                        <p className={'text-black'}>اسکن QR Code</p>
                                ...
                                <div className="mb-4 flex items-center justify-between">
                                    ...
                                    {action.started_by_team && (
                                        <div className="flex items-center gap-2">
                                            ...
                                            <FaPencilAlt size={16} className={'text-purple-500'} />
                                        </div>
                                    )}
                                </div>
